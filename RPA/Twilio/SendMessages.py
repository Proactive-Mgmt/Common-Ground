...
def sendMessage(client, to_phone_number):
    ...
    to_phone_number = "+12487237903"  # Replace with the recipient's phone number
    message_body = "Hello from your Python SMS app!"

    # Send the SMS
    message = client.messages.create(
        body=message_body, from_=my_twilio_phone_number, to=to_phone_number
    )
