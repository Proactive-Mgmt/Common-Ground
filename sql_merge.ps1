...
BEGIN
    ...
    SET [Timestamp] = '$timestamp',
        ...
        [sentOn] = '$sentOn',
        [Type] = '$type',
        [AreThereAnyOtherCommentsYouWouldLikeToMake] = '$AreThereAnyOtherCommentsYouWouldLikeToMake',
        [ContactSomeoneIfINeedSupport_before] = '$ContactSomeoneIfINeedSupportBefore',
        [ContactSomeoneIfINeedSupport_after] = '$ContactSomeoneIfINeedSupportAfter',
        [ExperienceOfSchedulingAnAppointment] = '$ExperienceOfSchedulingAnAppointment',
        [FindResourcesToHelpMe_before] = '$FindResourcesToHelpMeBefore',
        [FindResourcesToHelpMe_after] = '$FindResourcesToHelpMeAfter',
        [HaveTheAbilityToIdentifyTheThingsInLifeThatAreImportanToMe_before] = '$HaveTheAbilityToIdentifyTheThingsInLifeThatAreImportantToMeBefore',
        [HaveTheAbilityToIdentifyTheThingsInLifeThatAreImportanToMe_after] = '$HaveTheAbilityToIdentifyTheThingsInLifeThatAreImportantToMeAfter',
        [InformationClearly] = '$InformationClearly',
        [IfYouDidNotReceiveHelpThatYouExpectedWhatCouldWeHaveDoneBetter] = '$IfYouDidNotReceiveHelpThatYouExpectedWhatCouldWeHaveDoneBetter',
        [IfYouDidNotFeelMoreHopeWhenYouLeft] = '$IfYouDidNotFeelMoreHopeWhenYouLeft',
        [MeetTheGoalsThatISetForMyself_before] = '$MeetTheGoalsThatISetForMyselfBefore',
        [MeetTheGoalsThatISetForMyself_after] = '$MeetTheGoalsThatISetForMyselfAfter',
        [MoreHopeByVisit] = '$MoreHopeByVisit',
        [RecommendCommonGroundToFriendInNeed] = '$RecommendCommonGroundToFriendInNeed',
        [SatisfiedWithHelpReceived] = '$SatisfiedWithHelpReceived',
        [StaffFriendlyAndWelcoming] = '$StaffFriendlyAndWelcoming',
        [TryNewSolutionsToMyChallenges_before] = '$TryNewSolutionsToMyChallengesBefore',
        [TryNewSolutionsToMyChallenges_after] = '$TryNewSolutionsToMyChallengesAfter',
        [RateYourOverallExperience] = '$RateYourOverallExperience',
        [ReasonAppropriatelyAddressed] = '$ReasonAppropriatelyAddressed',
        [SurveyCompletedOn] = '$SurveyCompletedOn',
        [HowDidYouHearAboutBHUC] = '$HowDidYouHearAboutBHUC'
